...
public class SalaDAO {
    ...
    public void cadastrarSala(Sala sala){
     ...
     public List<String> buscarTodasAvaliacoes(Sala sala) {
        List<String> avaliacoes = new ArrayList<>();

        String sql = "select avaliacao_nome,avaliacao_data_final from avaliacao join sala " +
"on sala.sala_id = ?;";
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    String avaliacao_nome = rs.getString("avaliacao_nome");
                    String avaliacao_data_final = rs.getString("avaliacao_data_final");
                    avaliacoes.add(avaliacao_nome+" "+avaliacao_data_final);
                }
            }
